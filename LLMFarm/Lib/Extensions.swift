...
extension StringProtocol {
    ...
    extension UIImage {
        ...
        var fixedOrientation: UIImage {
            ...
            var rect = switch imageOrientation {
    ...
    public extension UIImage {
        ...
        internal func resizeWithScaleAspectFitMode(to dimension: CGFloat, resizeFramework: ResizeFramework = .accelerate) -> UIImage? {
        ...
        /// - Parameter resizeFramework: Technique for image resizing: UIKit / CoreImage / CoreGraphics / ImageIO / Accelerate.
        /// - Returns: Resized image.
        func resize(to newSize: CGSize, with resizeFramework: ResizeFramework = .accelerate) -> UIImage? {
...
//            case .imageIO: return resizeWithImageIO(to: newSize)
            case .accelerate: resizeWithAccelerate(to: newSize)
            }
        }
