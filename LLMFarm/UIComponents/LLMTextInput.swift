...
extension View {
    func messageInputViewHeight(_ value: CGFloat) -> some View {
        preference(key: MessageInputViewHeightKey.self, value: value)
    }
}
...
//                    .toggleStyle(SymbolToggleStyle(systemImage: "o.circle.fill", activeColor: .purple))
    ...
    private var attachButton: some View {
        Button(action: {
            isAttachmentPopoverPresented = true
        }) {
    ...
    public init(
        ...
        showAttachmentBtn = show_attachment_btn
        self.focusedField = focusedField
        _autoScroll = auto_scroll
