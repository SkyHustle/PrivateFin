...
struct ModelsView: View {
    ...
    @State var models_previews: [[String: String]]
    ...
    init(_ dir: String) {
        self.dir = dir
        _models_previews = State(initialValue: getFileListByExts(dir: dir, exts: targetExts)!)
    }

    func delete(at offsets: IndexSet) {
        let chatsToDelete = offsets.map { models_previews[$0] }
    ...
    func delete(at elem: [String: String]) {
        ...
        models_previews.removeAll(where: { $0 == elem })
        models_previews = getFileListByExts(dir: dir, exts: targetExts) ?? []
    }
